...
class SignUpPage extends StatelessWidget {
  ...
  SignUpPageController pageController = SignUpPageController();
            ...
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  MaterialButton(
                    onPressed: () => pageController.signUpHandler(),
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {Get.toNamed('/');},
                        child: const Text("Sign in here.", style: TextStyle(color: Colors.black, decoration: TextDecoration.underline),),
                      )
                    ],
                  ),
                ],
